  ...
  return (
    <div className="flex items-center gap-4 mb-5">
      <div className={`w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 ${
        danger ? "bg-red-50" : "bg-[#E6F7F3]"
      }`}>
        <Icon className={`h-5 w-5 ${danger ? "text-red-500" : "text-[#00A87E]"}`} />
      </div>
      <div>
        <p className="text-[10px] font-bold text-[#94A3B8] uppercase tracking-widest mb-0.5">{num}</p>
        <h2 className="text-xl font-heading font-bold text-[#0F172A]">{title}</h2>
      </div>
    </div>
  )
}
    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans">
      ...
      <div className="container mx-auto max-w-7xl px-4 lg:px-12 py-12 flex flex-col lg:flex-row gap-12 relative">
          ...
          <div className="bg-white rounded-2xl border border-[#E2E8F0] shadow-sm overflow-hidden">
            <button onClick={() => setTocOpen(o => !o)} aria-expanded={tocOpen}
              ...
              <span className="flex items-center gap-2">
                <Shield size={16} className="text-[#00A87E]" /> Jump to Section
              </span>
              ...
              <div className="border-t border-[#F1F5F9] px-3 pb-3 max-h-64 overflow-y-auto">
                {SECTIONS.map(s => (
                  <button key={s.id} onClick={() => scrollTo(s.id)}
                    ...
                    <span className="font-extrabold text-[#00A87E] w-6 flex-shrink-0">{s.num}</span>
                    {s.title}
                  </button>
                ))}
              </div>
        ...
        <div className="hidden lg:block w-72 shrink-0">
          <div className="sticky top-28 bg-white rounded-2xl shadow-sm border border-[#E2E8F0] p-6 max-h-[80vh] overflow-y-auto">
            <h3 className="font-heading font-bold text-[#0F172A] text-base mb-5 flex items-center gap-2">
              <Shield size={16} className="text-[#00A87E]" /> Contents
            </h3>
        ...
        <div className="flex-1 space-y-8 pb-20 min-w-0">
          ...
          <motion.section id="introduction" {...cardAnim}
            ...
            <p className="text-[#475569] font-medium leading-relaxed">
              ...
              laws including the <strong className="text-[#0F172A]">Information Technology Act, 2000</strong> and{" "}
              <strong className="text-[#0F172A]">Telemedicine Practice Guidelines (India)</strong>.
            </p>
          </motion.section>
          ...
          <motion.section id="data-usage" {...cardAnim}
            ...
            <p className="text-[#475569] font-medium leading-relaxed mb-5">
              User data is used to provide services, improve platform functionality, and maintain internal records.
            </p>
            {/* Teal callout */}
            <div className="bg-[#E6F7F3] border border-[#00A87E]/25 rounded-xl px-5 py-4 flex items-center gap-3">
          ...
          <motion.section id="data-security" {...cardAnim}
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <span key={chip.label}
                  className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#E6F7F3] border border-[#00A87E]/20 text-[#00A87E] text-xs font-bold">
          ...
          <motion.section id="telemedicine" {...cardAnim}
            ...
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#E6F7F3] border border-[#00A87E]/25 text-[#00A87E] text-xs font-bold">
          ...
          <motion.div {...cardAnim}
            ...
            <div className="relative z-10">
              <div className="w-12 h-12 bg-[#00A87E]/10 rounded-2xl flex items-center justify-center mx-auto mb-4 border border-[#00A87E]/20">
                <Shield className="h-6 w-6 text-[#00A87E]" />
              </div>
