...
function UnauthorizedContent() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center px-4">
      ...
      <div className="relative z-10 max-w-md w-full bg-white rounded-3xl border border-slate-200 shadow-xl p-8 md:p-12 text-center">
        {/* Icon */}
          ...
          {user ? (
            <>
              <Link href={dashboardHref}>
                <Button className="w-full sm:w-auto bg-[#00A87E] hover:bg-teal-700 text-white font-bold rounded-xl px-6 h-11 shadow-sm">
